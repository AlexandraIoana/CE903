...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <p>
        <asp:Label ID="AddPicLabel" runat="server" Text="Add More Pictures" Visible="false"></asp:Label>
    </p>
    <p>
    ...
    <p>
        ...
        <asp:Button ID="checkAvailability" runat="server" Text="Check Availability" class="btn btn-default" ValidateRequestMode="Disabled" Visible="false" PostBackUrl="~/Availability.aspx?host=true" />
    </p>
</asp:Content>
